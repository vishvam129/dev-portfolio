...
export const FS_PROJECTS: Project[] = [
  {
    ...
    status: "live", devices: ["desktop", "mobile"], preview: "map", accent: "#ef6c1f",
  ...
  },
  {
    ...
    status: "shipped", devices: ["mobile", "desktop"], preview: "chat", accent: "#e84b6b",
  ...
  },
  {
    ...
    status: "building", devices: ["desktop"], preview: "photo", accent: "#7c5cff",
